    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="DVCupones.php" class="current"><span>Cupones</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
		<div class="portlet">
            <div class="portlet-header"><img src="../../../images/icons/chart_bar.gif" width="16" height="16" alt="Reports" /> Generar Cupón </div>
            ...
            <div id="dialogo" title="Búsqueda de Venta">
              ...
              <form action="" method="post">
                ...
                <!-- IDVIAJERO --><input type="hidden" id="id" name="id">
                 ...
                 <input type="button" value="Buscar" id="btn_buscar_venta_cupon">
