...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
            <ul>
                      <li><a href="DBitacoras.php"><span>Ingresos</span></a></li>
                      <li><a href="DBEgresos.php" class="current"><span>Egresos</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
		<div class="portlet">
            <div class="portlet-header"><img src="../../../images/icons/chart_bar.gif" width="16" height="16" alt="Reports" /> Consultar los egresos de la Agencia </div>
            <div class="portlet-content" style="width:850px;">
            <!--THIS IS A PLACEHOLDER FOR FLOT - Report & Graphs -->
            <div id="placeholder">

                        <form action="../../../php/ReporteBitacoraE.php" method="GET" class="moverForm">
                          <label for="">Inicio</label><input type="text" name="fechaInicio" id="fechaB"> 
                          <label for="">Final</label><input type="text" name="fechaFinal" id="fechaFinalB">
                        ...
                        <div id="grid_Egresos"  style="width:800px; height:455px; "></div>
...
<script src="../../../js/kendo.culture.es-MX.min.js"></script>
  ...
  <script src="../../../js/appBitacoraE.js"></script> 
</body>
</html>
