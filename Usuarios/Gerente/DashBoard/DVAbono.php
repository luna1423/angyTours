...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
            <ul>
                      <li><a href="DVentas.php"><span>Nueva Venta</span></a></li>
                      <li><a href="DVAbono.php" class="current"><span>Nuevo Abono</span></a></li>
                      <li><a href="DVBorrar.php"><span>Borrar Venta</span></a></li> 
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="ventas">Nuevo Abono</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
		<div class="portlet">
            <div class="portlet-header"><img src="../../../images/icons/chart_bar.gif" width="16" height="16" alt="Reports" /> Ingresar nuevo Abono </div>
            ...
            <button style="width:150px; height:50px;" id="opener">
              ...
              <span class="enviar">Buscar Venta</span> 
            </button>
            ...
            <div id="dialogo" title="Búsqueda de Venta">
              ...
              <form action="" method="post" id="formulario"> 
                ...
                <label for="nombrePax"><strong>Nombre del Titular de la Venta:</strong></label>
                <input type="text" name="cliente" id="cliente">
                <!--NÚMERO DE FOLIO --><input type="hidden" name="numeroFolio" id="FolioVta">
     ...
     <div id="grid_Cerrados"  style="width:700px; height:455px; "></div>
