    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="DVBorrar.php" class="current"><span>Borrar Venta</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="ventas">Borrar Venta</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
    <div class="portlet">
            <div class="portlet-header"><img src="../../../images/icons/chart_bar.gif" width="16" height="16" alt="Reports" /> Borrar Venta Existente </div>
            ...
            <div id="dialogo" title="Búsqueda de Venta">
              ...
              <form action="" method="post" id="formulario"> 
                ...
                <input type="button" value="Buscar" id="btn_buscar_borrar"><br>
        ...
        <div id="grid_venta_borrar"  style="width:700px; height:455px; "></div>
