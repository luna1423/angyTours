...
<div id="menu">
  <ul class="group" id="menu_group_main">
        ...
        <li class="item middle" id="two"><a href="DRegistrar.php" class="main current"><span class="outer"><span class="inner registrar">Agregar Usuario</span></span></a></li>
...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
            <ul>
                      <li><a href="DRegistrar.php"><span>Registrar Cliente</span></a></li>
                      <li><a href="DRAgente.php" class="current"><span>Registrar Agente de Ventas</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="registrar">Registrar Agente de Ventas</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
		<div class="portlet">
            <div class="portlet-header"><img src="../../../images/icons/chart_bar.gif" width="16" height="16" alt="Reports" /> Registrar un Agente de Ventas nuevo </div>
            <div class="portlet-content" style="width:850px;">
            <!--THIS IS A PLACEHOLDER FOR FLOT - Report & Graphs -->
            <div id="formulario"> 

              <form action="../../../php/RegistrarAgente.php" method="POST" autocomplete="on">
