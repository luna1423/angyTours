    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="DPpagosCerrados.php" class="current"><span>Pagos Cerrados</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="pago">Pagos Cerrados</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
		<div class="portlet">
            <div class="portlet-header"><img src="../../../images/icons/chart_bar.gif" width="16" height="16" alt="Reports" /> Consultar Pagos Cerrados </div>
            <div class="portlet-content" style="width:850px;">
            <!--THIS IS A PLACEHOLDER FOR FLOT - Report & Graphs -->
            <div id="placeholder"> 
            <button id="btn_Cerrados">Ver Pagos Cerrados</button>
            <button id="btn_Cerrados_Grupo">Ver Pagos Cerrados Grupo</button>
            <div id="grid_Cerrados" style="width:700px; height:455px;"></div>
            <div id="grid_Cerrados_Grupo" style="width:700px; height:455px;"></div>            
            </div>
            </div>
        </div> 
      </div>      
