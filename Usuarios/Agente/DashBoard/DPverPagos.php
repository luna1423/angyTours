...
<!-- TABS START -->
    <div id="tabs">
         <div class="container">
            <ul>
                      <li><a href="DPagos.php" ><span>Nuevo Pago</span></a></li>
                      <li><a href="DPverPagos.php" class="current"><span>Ver Pagos</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
		<div class="portlet">
            <div class="portlet-header"><img src="../../../images/icons/chart_bar.gif" width="16" height="16" alt="Reports" /> Consultar Pagos </div>
            <div class="portlet-content" style="width:850px;">
            <!--THIS IS A PLACEHOLDER FOR FLOT - Report & Graphs -->
            <div id="placeholder"> <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean  adipiscing massa quis arcu interdum scelerisque. Duis vitae nunc nisi.  Quisque eget leo a nibh gravida vulputate ut sed nulla.</p></div>
            </div>
        </div> 
      </div>      
