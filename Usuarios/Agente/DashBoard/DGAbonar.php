    ...
    <div id="tabs">
         <div class="container">
            <ul>
                      ...
                      <li><a href="DGAbonar.php" class="current"><span>Abonar Grupo</span></a></li>
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
    <h1 class="grupos">Abonar Grupo</h1>
    </div>
    <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <!-- FIRST SORTABLE COLUMN START -->
      ...
      <!--THIS IS A PORTLET-->
		<div class="portlet">
            <div class="portlet-header"><img src="../../../images/icons/chart_bar.gif" width="16" height="16" alt="Reports" /> Registrar Abono</div>
            ...
            <div id="dialogo" title="Búsqueda de Venta">
              ...
              <form action="" method="post" id="formulario"> 
                ...
                <input type="button" value="Buscar" id="btn_buscar_grupo"><br>
          ...
          <div id="grid_grupo_abonar"  style="width:700px; height:455px; "></div>
            <!--  FIn mi codigo consulta -->
